...
export function useWordByCategory() {
    ...
    const { 
        ...
        isValidating, 
        mutate 
    } = useSWR<IWordByCategoryResponse>("/api/statistics", fetcchSimple)
    return {
...
export function useWordByLevel() {
    ...
    const { 
        ...
        isValidating, 
        mutate 
    } = useSWR<IWordByLevelResponse>("/api/statistics", fetcchSimple)
    return {
...
export function useGrammarByLevel() {
    ...
    const { 
        ...
        isValidating, 
        mutate 
    } = useSWR<IGrammarByLevelResponse>("/api/statistics", fetcchSimple)
    return {
